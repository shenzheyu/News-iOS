//
//  HeadlinesBusinessController.swift
//  News
//
//  Created by Zheyu Shen on 5/5/20.
...
class HeadlinesBusinessController: UITableViewController {
    ...
    func requestHeadlines() {
        Alamofire.request("https://csci571-homework9-news-api.ue.r.appspot.com/articles/business").responseJSON{ response in
...
extension HeadlinesBusinessController: IndicatorInfoProvider {
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "BUSINESS")
    }
}

extension HeadlinesBusinessController: addBookmarkDelegate {
