//
//  HeadlinesTechnologyController.swift
//  News
//
...
class HeadlinesTechnologyController: UITableViewController {
    ...
    func requestHeadlines() {
        Alamofire.request("https://csci571-homework9-news-api.ue.r.appspot.com/articles/technology").responseJSON{ response in
...
extension HeadlinesTechnologyController: IndicatorInfoProvider {
...
extension HeadlinesTechnologyController: addBookmarkDelegate {
