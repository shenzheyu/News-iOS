//
//  HeadlinesSportsController.swift
//  News
//
...
class HeadlinesSportsController: UITableViewController {
    ...
    func requestHeadlines() {
        Alamofire.request("https://csci571-homework9-news-api.ue.r.appspot.com/articles/sport").responseJSON{ response in
...
extension HeadlinesSportsController: IndicatorInfoProvider {
...
extension HeadlinesSportsController: addBookmarkDelegate {
