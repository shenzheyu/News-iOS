//
//  HeadlinesWorldController.swift
//  News
//
...
class HeadlinesWorldController: UITableViewController {
    ...
    func requestHeadlines() {
        Alamofire.request("https://csci571-homework9-news-api.ue.r.appspot.com/articles/world").responseJSON{ response in
...
extension HeadlinesWorldController: IndicatorInfoProvider {
...
extension HeadlinesWorldController: addBookmarkDelegate {
