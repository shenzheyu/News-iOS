//
//  HeadlinesPoliticsController.swift
//  News
//
...
class HeadlinesPoliticsController: UITableViewController {
    ...
    func requestHeadlines() {
        Alamofire.request("https://csci571-homework9-news-api.ue.r.appspot.com/articles/politics").responseJSON{ response in
...
extension HeadlinesPoliticsController: IndicatorInfoProvider {
...
extension HeadlinesPoliticsController: addBookmarkDelegate {
